...
SECRET_KEY = 'xrv-f24tnt@xqb_n*s0hnylh$ysx9bpbts2-dt7$ngkqh%pw2o'
...
# List of domains that allows access to
# the data in the django app
# CORS_ORIGIN_WHITELIST = [
#     "http://localhost:3000",  # where react is hosted
#     "http://127.0.0.1:3000",
# ]
